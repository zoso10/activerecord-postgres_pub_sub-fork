...
module ActiveRecord
  module PostgresPubSub
    class Listener
      ...
      def self.listen(
        *channels, listen_timeout: nil, exclusive_lock: true, notify_only: true, active_record: ActiveRecord::Base
      )
      ...
      def with_connection
        active_record.connection_pool.with_connection do |connection|
